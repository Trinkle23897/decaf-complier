...
//		Symbol v = table.lookupBeforeLocation(varIdent.name, varIdent.getLocation());
//		System.out.println("var??? "+v.getName());
//		if (v != null && varIdent.getLocation().compareTo(v.getLocation()) > 0) {
//			System.out.println(v.getLocation()+" "+varIdent.getLocation());
//			varIdent.type = BaseType.ERROR;
//			issueError(new DeclConflictError(varIdent.getLocation(), varIdent.name, v.getLocation()));
//		}
//		else {

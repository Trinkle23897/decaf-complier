...
//		} else {
//			foreach.block = new Tree.Block(null, foreach.getLocation());
//		}
...
//		Symbol sym = table.lookup(foreach.exdef.name, true);
//		System.out.println("first decl "+v.getName()+" "+v.getLocation());
		table.declare(v);
...
//		System.out.println("varIdent "+v.getName());
		if (sym != null) {
...
//			System.out.println("first decl "+v.getName());
			table.declare(v);
		}
		varIdent.symbol = v;
	}
...
//		System.out.println("build "+varDef.name);

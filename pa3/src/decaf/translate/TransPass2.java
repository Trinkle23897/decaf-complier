...
public class TransPass2 extends Tree.Visitor {
	...
	public void visitScopy(Tree.Scopy scopy) {
		...
		int size = ((ClassType)scopy.expr.type).getSymbol().getSize() / OffsetCounter.WORD_SIZE - 1;
		while (size > 0) {
			Temp t41 = tr.genLoad(scopy.expr.val, OffsetCounter.WORD_SIZE * size);
			tr.genStore(t41, t40, OffsetCounter.WORD_SIZE * size);
			size--;
		}
